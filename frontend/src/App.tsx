  ...
  return (
    <div className="app-container">
      <header className="glass-header">
        <h1>Vibe LeadGen Agents</h1>
        <p>B2B Local Lead Discovery & Outreach</p>
      </header>
        ...
        <section className="glass-panel setup-panel">
          ...
          <form onSubmit={generateLeads} className="setup-form">
            ...
            <div className="form-group">
              <label>
                Number of Leads 
                <span style={{ fontSize: '0.8rem', color: '#ffb74d', fontWeight: 'normal', marginLeft: '8px' }}>
                  (Use 1 if on Gemini Free Tier)
                </span>
              </label>
        ...
        <section className="glass-panel results-panel">
          ...
          {loading && (
            <div className="loading-state">
              ...
              <p>Agents are scanning local listings, researching websites, and drafting pitches...</p>
            </div>
          )}
          
          {!loading && drafts.length === 0 && !error && (
            <div className="empty-state">
              <p>No drafts yet. Configure your business and dispatch the agents!</p>
            </div>
          )}
